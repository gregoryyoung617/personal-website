  ...
  return (
    <>
      <section className="contact-section">
        ...
        <div className="contact-container section-background">
          <div className="logo-container column-container">
            <img className="contact-svg" src={emailsvg}></img>
            <a
              href="https://www.linkedin.com/in/gregory-young-76170024b/"
              target="_blank"
            >
              <img className="contact-svg" src={linkedinsvg}></img>
            </a>
            <a href="https://github.com/gregoryyoung617" target="_blank">
              <img className="contact-svg" src={githubsvg}></img>
            </a>
          </div>
